...
export const hotelsData = [
  {
    ...
    availabilityFrom: today.getTime(),
    availabilityTo: today.getTime() + 864000000, // 10 days
    rooms: 11,
    city: "Buenos Aires",
    country: "Argentina",
    price: 4
  },
  {
    ...
    availabilityFrom: today.getTime() + 864000000, // 10 days
    availabilityTo: today.getTime() + 1296000000, // 15 days
    rooms: 23,
    city: "Mar del Plata",
    country: "Argentina",
    price: 2
  },
  {
    ...
    availabilityFrom: today.getTime() + 432000000, // 5 days
    availabilityTo: today.getTime() + 1296000000, // 15 days
    rooms: 16,
    city: "Mendoza",
    country: "Argentina",
  ...
  },
  {
    ...
    availabilityFrom: today.getTime() + 1728000000, // 20 days
    availabilityTo: today.getTime() + 2592000000, // 30 days
    rooms: 32,
    city: "Jujuy",
    country: "Argentina",
    price: 1
  },
  {
    ...
    availabilityFrom: today.getTime(),
    availabilityTo: today.getTime() + 432000000, // 5 days
    rooms: 14,
    city: "Salta",
    country: "Argentina",
    price: 2
  },
  {
    ...
    availabilityFrom: today.getTime() + 1296000000, // 15 days
    availabilityTo: today.getTime() + 2592000000, // 30 days
    rooms: 16,
    city: "Córdoba",
    country: "Argentina",
  ...
  },
  {
    ...
    availabilityFrom: today.getTime() + 2592000000, // 30 days
    availabilityTo: today.getTime() + 3456000000, // 40 days
    rooms: 40,
  ...
  },
  {
    ...
    availabilityFrom: today.getTime() + 864000000, // 10 days
    availabilityTo: today.getTime() + 1728000000, // 20 days
    rooms: 21,
    city: "Pucón",
    country: "Chile",
    price: 4
  ...
  },
  {
    ...
    availabilityFrom: today.getTime() + 2160000000, // 25 days
    availabilityTo: today.getTime() + 2592000000, // 30 days
    rooms: 4,
    city: "Colonia",
    country: "Uruguay",
